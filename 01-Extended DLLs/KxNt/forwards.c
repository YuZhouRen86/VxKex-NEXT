//This function is used by SspiCli.dll on Windows 8 and above.
#pragma comment(linker, "/EXPORT:RtlCheckTokenMembershipEx=ntdll.RtlCheckTokenMembershipEx")
//These functions are used by icacls.exe on Windows 8 and above.
#pragma comment(linker, "/EXPORT:RtlIsPackageSid=ntdll.RtlIsPackageSid")
#pragma comment(linker, "/EXPORT:RtlIsCapabilitySid=ntdll.RtlIsCapabilitySid")
