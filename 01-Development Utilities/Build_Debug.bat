...
timeout /t 1 /nobreak
call SetEnv.Cmd /x64
MSBuild.exe "%~dp0\..\VxKex.sln" /p:Configuration=Debug /p:Platform="x64" /p:PlatformToolset=!TOOLSET!
timeout /t 1 /nobreak
call SetEnv.Cmd /x86
MSBuild.exe "%~dp0\..\VxKex.sln" /p:Configuration=Debug /p:Platform="Win32" /p:PlatformToolset=!TOOLSET!
