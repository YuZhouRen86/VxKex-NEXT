...
- **解除安裝**  
  ...
  - **0patch Agent**  
    它可能導致基於 Chromium 的瀏覽器和 JetBrains IDE 在啟用 VxKex NEXT 並執行後當機。
...
如需獲取更多資訊，請參閱與 VxKex NEXT 一起安裝的**Application Compatibility List.docx**檔案。
...
**答**：沒有任何更新的 Windows 7 使用者仍可使用它，但許多程式需要安裝 Service Pack 1、KB2533623（DllDirectories 更新）和 KB2670838（平臺更新）才能執行。最好安裝這些更新。
