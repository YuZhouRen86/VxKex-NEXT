	...
	IN	LPARAM	LParam)
{
	...
	if (Message == WM_INITDIALOG) {
		...
		ToolTip(Window, IDUSEVXKEX, (PWSTR)_(
			L"Enable or disable the main VxKex NEXT compatibility layer."));
		ToolTip(Window, IDSPOOFVERSIONCHECK, (PWSTR)_(
		...
		ToolTip(Window, IDSTRONGSPOOF, (PWSTR)_(
		...
		ToolTip(Window, IDDISABLEFORCHILD, (PWSTR)_(
		...
		ToolTip(Window, IDDISABLEAPPSPECIFIC, (PWSTR)_(
